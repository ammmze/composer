...
class ArtifactoryRepositoryTest extends TestCase
{
    ...
    public function testExtractsConfigsFromZipArchives()
    {
        ...
        $coordinates = array('type' => 'artifact', 'url' => 'http://maven1.docufide.local:8081/artifactory/', 'searchName' => 'member-service-api-php-client*.jar', 'repos' => ['libs-snapshot-local', 'libs-release-local']);
        $repo = new ArtifactoryRepository($coordinates, new NullIO(), new Config());
